...
namespace Extension.CompositionRoot.Modules
{
    public class DefaultModule : NinjectModule
    {
        ...
        internal DTE2 _dte; //do not remove! https://social.msdn.microsoft.com/Forums/en-US/eb6cc3eb-422a-48b1-86da-7a81d3edbddc/events-not-captured-afte-a-window-is-opened?forum=vsx    Your solution events aren't firing because the objects are getting collected
