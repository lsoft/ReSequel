...
namespace Extension.Command
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class InclusionListCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        public const int CommandId = 4434;
        ...
        /// </summary>
        public static InclusionListCommand Instance
        {
            get;
            private set;
        }
            ...
            )
        {
            ...
            Instance = new InclusionListCommand(
                package,
                commandService
                );
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            //var parseResult = _configurationProvider.TryReadConfiguration(out _);
            //if (!parseResult)
            //{
            ...
            ToolWindowPane window = this.package.FindToolWindow(typeof(InclusionListWindow), 0, true);
